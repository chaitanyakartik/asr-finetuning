...
BENCHMARK_NAME = "kn_en_codeswitch"  # Name for the benchmark
OUTPUT_DIR = "test_data/Vaani"
WAV_DIR = os.path.join(OUTPUT_DIR, "wavs")
BENCHMARK_DIR = "evaluation/benchmarking/data/v1"
...
def run_vaani_pipeline():
    ...
    try:
        ...
        ds = load_dataset(
            HF_DATASET_ID, 
            HF_CONFIG, 
            split="test",  # Vaani uses 'test' split
            streaming=True, 
            token=hf_token
        )
        ...
        # Save to test_data (for development/testing)
        ...
        # Save to benchmark directory (versioned)
        benchmark_manifest_path = os.path.join(BENCHMARK_DIR, f"{BENCHMARK_NAME}.json")
        ...
        print(f"   📄 Benchmark Manifest: {benchmark_manifest_path}")
